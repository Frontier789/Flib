...
namespace fm
{
	...
	namespace priv
	{
		...
		public:
			...
			static inline R call(ObjectType *object,R (ObjectType::*funcPtr)(Args...),Args... args,ExtraArgs...)
			{
	...
	/////////////////////////////////////////////////////////////
	template<class ObjectType,class AltR,class FuncArgList,class R,class... Args>
	bool ObjMemFuncDelegate<ObjectType,AltR,FuncArgList,R,Args...>::isBaseDelegate() const
	{
		return false;
	}
}
