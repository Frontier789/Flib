...
namespace fg
{
	...
	inline typename std::enable_if<fg::Is_GLDataType<T>::value,DrawData::Attribute>::type &DrawData::Attribute::operator=(const T (&data)[N])
    {
        return set(data);
    }
    ...
    //////////////////////////////////////////////////////////////////////////
    template<class T,fm::Size N>
    inline typename std::enable_if<fg::Is_GLDataType<T>::value,DrawData::Attribute>::type &DrawData::Attribute::set(const T (&data)[N])
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    template<class T>
    inline typename std::enable_if<fg::Is_GLDataType<T>::value,DrawData::Attribute>::type &DrawData::Attribute::set(const T *pointer,fm::Size N)
    {
