...
namespace fn
{
	fm::Error getLastError(const char *netFunc,const char *file,int line)
	{
		...
		DWORD errors[] = {           WSAENETDOWN,               WSAEAFNOSUPPORT,         WSAEMFILE,         WSAEINVAL,        WSAENOBUFS,      WSAEPROTONOSUPPORT,                        WSAESOCKTNOSUPPORT,           WSAEADDRINUSE,             WSAEALREADY,     WSAECONNREFUSED,                   WSAENETUNREACH,               WSAEHOSTUNREACH,                        WSAECONNRESET,            WSAEOPNOTSUPP,           WSAENOTCONN};                       																
		std::string descs[] = {"Network is down","Address family not supported","Out of resources","Out of resources","Out of resources","Protocol not supported","Invalid value specified in internal code","Address already in use","Address already in use","Connection refused","Destination network unreachable","Destination host unreachable","Connection was reset by remote host","Operation not supported","Socket not connected"};
		std::string types[] = {        "NetDown",                "NotSupported",        "OutOfRes",        "OutOfRes",        "OutOfRes",          "NotSupported",                           "InternalError",          "AlreadyInUse",          "AlreadyInUse", "ConnectionRefused",                "DestUnreachable",             "DestUnreachable",                           "ConReset",           "NotSupported",        "NotConnected"};
