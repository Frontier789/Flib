...
namespace fm
{
    fm::Error WapiGetLastErrorFunc(const char *functionName,const char *file, unsigned int line)
	{
		std::string ret;
		...
		return fm::Error("WapiError",fm::toString(err),ret,functionName,file,line);
	}
}
