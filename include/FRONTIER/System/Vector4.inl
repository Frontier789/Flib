...
namespace fm
{
	...
	template<class T> vector4<T> vector4<T>::Magenta     = vector4<T>::fromHex(0xFF00FFFF);
	template<class T> vector4<T> vector4<T>::Fuchsia     = vector4<T>::fromHex(0xFF00FFFF);
	template<class T> vector4<T> vector4<T>::Darkmagenta = vector4<T>::fromHex(0x8B008BFF);
	template<class T> vector4<T> vector4<T>::Ivory       = vector4<T>::fromHex(0xFFFFF0FF);
	template<class T> vector4<T> vector4<T>::Rose        = vector4<T>::fromHex(0xFF007FFF);
