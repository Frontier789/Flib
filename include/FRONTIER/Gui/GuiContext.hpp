...
namespace fgui
{
	...
	public:
		...
		/////////////////////////////////////////////////////////////
		/// @brief Remove all the added elements from the main layout
		/// 
		/// Also clears added drawables
		/// 
		/////////////////////////////////////////////////////////////
		void clearElements();
		
		/////////////////////////////////////////////////////////////
		/// @brief Destroy all sprites of the window
		/// 
		/// Does not remove added images, only sprites
		/// 
		/////////////////////////////////////////////////////////////
		void clearSprites();
