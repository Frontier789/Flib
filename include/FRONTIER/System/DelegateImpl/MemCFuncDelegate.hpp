...
///                                                                    ///
////////////////////////////////////////////////////////////////////////// -->
#ifndef FRONTIER_MEMCFUNCDELEGATE_HPP_INCLUDED
#define FRONTIER_MEMCFUNCDELEGATE_HPP_INCLUDED
#include <FRONTIER/System/DelegateImpl/BaseDelegate.hpp>
#define FRONTIER_MEMCFUNCDELEGATE
...
namespace fm
{
	...
	class MemCFuncDelegate : public priv::BaseDelegateIfCompatible<AltR,FuncArgList,R,Args...>::type
	{
	public:
		...
		/// 
		/////////////////////////////////////////////////////////////
		MemCFuncDelegate(FuncType memFuncPtr,ObjectType object = ObjectType());
...
#endif // FRONTIER_MEMCFUNCDELEGATE_HPP_INCLUDED

#ifndef FRONTIER_DONT_INCLUDE_INL
	#include <FRONTIER/System/DelegateImpl/MemCFuncDelegate.inl>
#endif
