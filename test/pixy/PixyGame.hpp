...
public:
	...
	/////////////////////////////////////////////////////////////
	virtual void onHover(vec2s p,bool on);

	/////////////////////////////////////////////////////////////
	virtual void onClick(vec2s p,Mouse::Button btn);
	...
	/////////////////////////////////////////////////////////////
	string getMapImage(vec2i p) const;

	/////////////////////////////////////////////////////////////
	void setMapColor(vec2i p,vec4 c);

	/////////////////////////////////////////////////////////////
	void setMapImage(vec2i p,string imgName);

	/////////////////////////////////////////////////////////////
	vec2s getMapSize() const;

	/////////////////////////////////////////////////////////////
	fm::Result loadImage(string fileName,string imgName = "");

	/////////////////////////////////////////////////////////////
	void setTitle(fm::String title);

	/////////////////////////////////////////////////////////////
	void setCursor(Mouse::Cursor cur);

	/////////////////////////////////////////////////////////////
	bool isButtonPressed(Mouse::Button btn);
};
