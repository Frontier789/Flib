...
namespace fg
{
	namespace GL
	{
		...
		///
		//////////////////////////////////
		fm::Result FRONTIER_API glCheckError(const char *file, unsigned int line,const char *call = fm::nullPtr);
		...
		///
		//////////////////////////////////
		fm::Error FRONTIER_API getLastGLError();
		...
		///
		//////////////////////////////////
		void FRONTIER_API raiseGLError(const fm::Error &error);
		...
		///
		//////////////////////////////////
		void FRONTIER_API setGLErrorListener(const fm::Delegate<void,const fm::Error &> &callback);
	}
}
